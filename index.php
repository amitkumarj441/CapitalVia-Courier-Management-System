...
<title>CapitalVia - Courier Management System</title>
<meta name="keywords" content="Express, Courier, Service" />
...
<div id="templatemo_header">
    <div id="site_title">
	<h2 align="center"><img src="images/icon.png" alt="Courier" width="70px" height="70px" />
	<span style="font:'Courier New', Courier, monospace">CapitalVia - Courier Management System</span></h2>
</div>
</div>

	<div id="wowslider-container1">
	<div class="ws_images"><ul>
<li><img src="data1/images/capitalvia-logo.jpg" alt="CapitalVia ®" title="CapitalVia ®" id="wows1_0"/></li>
<li><img src="data1/images/5_big.jpg" alt="we know WE CAN DELIVER..." title="we know WE CAN DELIVER..." id="wows1_1"/></li>
<li><img src="data1/images/centrebanner_courier.jpg" alt="Customer Service" title="Customer Service" id="wows1_2"/></li>
</ul></div>
<div class="ws_bullets"><div>
<a href="#" title="CapitalVia ®"><img src="data1/tooltips/capitalvia-logo.jpg" alt="SidEx Express ®"/>1</a>
<a href="#" title="we know WE CAN DELIVER..."><img src="data1/tooltips/5_big.jpg" alt="we know WE CAN DELIVER..."/>2</a>
<a href="#" title="Customer Service"><img src="data1/tooltips/centrebanner_courier.jpg" alt="Customer Service"/>3</a>
</div></div>
<span class="wsl"><a href="http://wowslider.com">Slideshow Online</a> by WOWSlider.com v5.2</span>
    ...
    <div id="content"> 
		<div id="home" class="section">
			...
			<div id="home_about" class="box">
           	  <h3 style="font:Verdana, Arial, Helvetica, sans-serif">Welcome</h3><p>&nbsp;&nbsp;</p>
                <p><strong>CapitalVia Global Research Limited is an investment advisory, which provides trading recommendations on Stock & Commodity markets.</strong></p><p>&nbsp;&nbsp;</p>
              <p>“based on technical research.”</p>
            </div>
            ...
            <div class="box home_box2 color3">
            	<div id="social_links">
                    <a href="https://www.facebook.com/amitkumar.jaiswal" target="_blank"><img src="images/facebook.png" alt="Facebook" /></a>
					<a href="#"></a>
                    <a href="https://twitter.com/amit_gkp" target="_blank"><img src="images/twitter.png" alt="Twitter" /></a>
                    <a href="#"></a>
                    <a href="https://www.youtube.com/user/amitkumarj441" target="_blank"><img src="images/youtube.png" alt="YouTube" /></a>
        ...
        <div class="section section_with_padding" id="about"> 
            ...
            <div class="img_border img_fl">
                <img src="images/fulfillment.jpg" alt="image" width="395" height="208" />            </div>
	 ...
	 <td class='login_table' align='left'><form action='logging.php' method='post'>
	   <table class="login_tab">
            ...
            <div class="half right">
                ...
                <iframe width="425" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.co.in/maps/place/CapitalVia+Global+Research+Limited/@22.7519419,75.8945633,17z/data=!3m1!4b1!4m5!3m4!1s0x3962fd16c7a52043:0xdc426f6cb0c4b74b!8m2!3d22.751937!4d75.896752?hl=en"></iframe><br /><small><a href="https://www.google.co.in/maps/place/Indian+Institute+of+Management+Indore/@22.6256777,75.788736,17z/data=!3m1!4b1!4m5!3m4!1s0x3962f943cadc375f:0x9d68305dec8cb187!8m2!3d22.6256728!4d75.7909247" style="color:#0000FF;text-align:left">View Larger Map</a></small>
...
<div id="templatemo_footer">
    Copyright © 2016 <a href="#">Amit Kumar Jaiswal</a> | Designed using <a href="#">PHP and MySQL</a>
</div>
